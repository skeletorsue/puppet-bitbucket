...
describe 'bitbucket', unless: UNSUPPORTED_PLATFORMS.include?(fact('osfamily')) do
  ...
  describe user('bitbucket') do
    ...
    it { is_expected.to belong_to_group 'bitbucket' }
